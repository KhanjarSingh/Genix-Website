...
export function ContactPage() {
  ...
  const roleData = {
    beta: {
      icon: '⚡',
      name: 'Beta Tester',
      desc: 'Train with Genyx before launch. Help shape the product.',
      tag: 'Beta Access',
      response: '48h',
      purpose: 'Early pilot for coaches and facilities testing live movement intelligence.',
      checklist: ['Pilot onboarding call', 'Role-fit review', 'Deployment recommendation', 'Priority beta access'],
